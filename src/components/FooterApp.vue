<template>
  <div class="footer">
    <div class="left">
      <h1>Dibuat dengan ❤️ oleh Hadi Gunawan</h1>
      <div class="sosmed">
        <h2>Follow</h2>
        <ul>
          <li>
            <a href="https://facebook.com/hadi.guawa/" target="_blank">
              <svg
                width="48"
                height="48"
                viewBox="0 0 48 48"
          ...
          <li>
            <a href="https://www.instagram.com/hadig.exe/" target="_blank">
              <svg
                width="48"
                height="48"
                viewBox="0 0 48 48"
          ...
          <li>
            <a href="https://t.me/hadi_ah_hehe" target="_blank">
              <svg
                width="48"
                height="48"
                viewBox="0 0 48 48"
    ...
    <div class="right">
      ...
      <div class="form">
        <textarea v-model="text" placeholder="Masukkan pesan anda disini..."></textarea>
...
export default {
    ...
    methods:{
        kirim(){
            window.open(`https://wa.me/6285361585645?text=${this.text}`,'_blank');
